Feature: Drop player
  ...
  Scenario: Drop a player after some rounds
    ...
    | 1 | tete   | Butcher2, Koslov1 / 2     | 1. teuteu  | Butcher2  | 4. Phantom | Koslov1    | 1. tyty   |
    | 4 | teuteu | Vyros1, Helynna1 / 2      | 1. tete    | Vyros1    | 1. titi    | Helynna1   | 3. toto   |
    | 5 | titi   | Amon1, Feora1 / 2         | 2. toto    | Amon1     | 1. teuteu  | Feora1     | 2. tutu   |
    | 3 | toto   | Bethayne1, Absylonia1 / 2 | 2. titi    | Bethayne1 | 3. toutou  | Absylonia1 | 3. teuteu |
    | 7 | toutou | Lylyth2 / 2               | 3. tutu    | Lylyth2   | 3. toto    | Lylyth2    | Droped    |
    | 6 | tutu   | Bartolo1, Cyphon1 / 2     | 3. toutou  | Bartolo1  | 2. tyty    | Cyphon1    | 2. titi   |
    | 2 | tyty   | Malekus1 / 2              | 4. Phantom |           | 2. tutu    | Malekus1   | 1. tete   |
    When I open Ranking page
